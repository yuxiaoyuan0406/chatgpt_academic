...
def main():
    ...
    if CUSTOM_PATH != "/": 
        ...
        run_gradio_in_subpath(app_block, auth=AUTHENTICATION, port=PORT, custom_path=CUSTOM_PATH)
    else: 
        app_block.launch(server_name="0.0.0.0", server_port=PORT, auth=AUTHENTICATION, favicon_path="docs/logo.png",
